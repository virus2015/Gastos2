 ...
 * @author jorge.lopez
 */
@WebServlet(name = "ServEditarGastosVariables", urlPatterns = {"/ServEditarGastosVariables"})
public class ServEditarGastosVariables extends HttpServlet {
...
//FECHA                     DATE   
        ...
        Double precioarticulo = Double.parseDouble(request.getParameter("precioarticulo"));
         ...
         gd.setFecha(fecha);
         gd.setIdGastos(idgastos);
         
         try{
         gn.Editar(gd);
         
         
         response.sendRedirect("IngresarGastosVariables.jsp");
         }catch(Exception ex){
           ex.printStackTrace();
         }
