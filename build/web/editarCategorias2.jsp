...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
  ...
  <%
     Conexion con = new Conexion();
        ...
        String  sql="select * from categoriasg2 where idCategorias ="+id;
  ...
  <form action="/Gastos2/ServEditarCategorias2" method ="POST">
    
    <div class="form-group">
      <label for="id">Id:</label>
      <input type="text" class="form-control" value="<%=resultado.getString("idcategorias") %>" name="id" required>
    </div>  
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" value="<%=resultado.getString("detalles") %>"  name="detalle" required>
    </div>
