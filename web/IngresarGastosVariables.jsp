...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
  ...
  <p>Gastos Variables joven</p>
  <div class="container">
   <form action="/Gastos2/ServInsertarGastosVariables" method ="POST">  
  ...
  <div class="form-group">
     ...
     List <CategoriasD>  cad  = cn.consultarTodos3();
...
%>
  ...
  <table class="table table-hover">
   ...
   resultado   = psmt.executeQuery("select g2.idgastos AS idgastos,a2.nombre as nombre,a2.descripcion as detalle,"
           ...
           + "  on cr2.idcreditos= g2.frk_idcredito where c2.frk_idgastos=3"); 
  %>
      </tr>
    ...
    resultado   = psmt.executeQuery("select g2.idgastos AS idgastos,a2.nombre as nombre,a2.descripcion as detalle,"
           ...
           + " on c2.idcategorias = a2.frk_idCategorias "
           + "  inner join creditosg2 cr2  "
           + "  on cr2.idcreditos= g2.frk_idcredito where a2.nombre like '%"+descripcion+"%' and c2.frk_idgastos=3 "); 
    ...
    <tbody>
      <tr>
             ...
             <td><a href="/Gastos2/ServEliminarGastosVariables?id=<%=resultado.getString("idgastos") %>"><button type="button" class="btn btn-danger">Eliminar</button></a> </td>
             <td><a href="/Gastos2/EditarGastosVariables.jsp?id=<%=resultado.getString("idgastos") %>"><button type="button" class="btn btn-success">Editar</button> </a> </td>
      </tr>
