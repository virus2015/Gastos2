...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
 ...
 <div class="container">
     ...
     <h2>Editar Gastos</h2>
  <p>Editar los Gastos</p>
                
   <form action="/Gastos2/ServEditarGastos2" method ="POST">  
       ...
       <%
        ...
        String  sql3=" select g2.idgastos,g2.frk_idarticulos,a2.nombre,g2.frk_idcredito,g2.precioarticulo,g2.preciokg_paquete,"
                + "g2.cantidad,g2.fecha from gastosg2 g2  inner join articulosg2 a2 "
                + " on g2.frk_idarticulos =a2.idarticulos  where idgastos = "+id3;
